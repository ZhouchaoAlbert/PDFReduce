    ...
    for( CMarkupNode node = pRoot->GetChild() ; node.IsValid(); node = node.GetSibling() ) {
		...
		//树控件XML解析
            ...
            case 8:
				...
				else if (_tcscmp(pstrClass, _T("TreeData")) == 0)			  pControl = new CTreeDataUI;//houbin add
                break;
            case 9:
            ...
            case 10:
				...
				else if( _tcscmp(pstrClass, _T("TreeLayout")) == 0 )          pControl = new CTreeLayoutUI;//houbin add
                break;
			case 11:
				if (_tcscmp(pstrClass, DUI_CTR_CHILDLAYOUT) == 0)			  pControl = new CChildLayoutUI;
				else if( _tcscmp(pstrClass, _T("TreeElement")) == 0 )		  pControl = new CTreeElementUI();//houbin add
				break;
            case 14:
            ...
            case 16:
                ...
                else if( _tcscmp(pstrClass, _T("TreeChildElement")) == 0 )    pControl = new CTreeChildElementUI();//houbin add
				break;
            case 20:
