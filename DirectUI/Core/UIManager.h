...
#define WM_SELFPAINT	(WM_USER + 2222)
...
public:
	...
	bool GetUnfocusPaintWindow();

	bool AddAnimationJob(const CDxAnimationUI& _DxAnimationUI);
	void SetSelfPaint(bool b);
    void SetEventClick(CControlUI *pEventClick);
    CControlUI * GetEventClick();
private:
