...
public:
	...
	//拖拽相关
	virtual void OnDropEnter(IDataObject *pDataObj, DWORD grfKeyState, POINT pt, DWORD *pdwEffect);
	virtual void OnDropOver(DWORD grfKeyState, POINT pt, DWORD *pdwEffect);
	...
	virtual void SetDropEnabled(bool bDragEnabled);
