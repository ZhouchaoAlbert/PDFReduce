...
//
class UILIB_API IPreMsgReceiver
{
public:
	IPreMsgReceiver();
	virtual ~IPreMsgReceiver();

	virtual bool PreTranslateMsg(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam) = 0;
};
...
protected:
    ...
    bool m_bSubclassed;
	static CStdPtrArray m_aPreMsgReceiver;
